#!/usr/bin/env python3
"""
Convert CityGML (.gml) RoofSurfaces to LAS point clouds.

Reads all .gml files from outputs/00_gml_wall_merged, extracts only
RoofSurface polygons, samples points on the triangulated polygons,
and writes one .las per input file into outputs/08_roof_points.
"""
...
OUTPUT_DIR = 'outputs/08_roof_points'
...
def main():
    ...
    for gml_path in gml_files:
        ...
        print(f"  Extracted {len(surfaces)} RoofSurface polygon(s)")
