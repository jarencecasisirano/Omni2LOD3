...
SCRIPT_VALIDATE = os.path.join(SCRIPTS_ROOT, "las_to_lod2", "03_validate_val3dity.py")
SCRIPT_FIX = os.path.join(SCRIPTS_ROOT, "las_to_lod2", "04_json_fix.py")
SCRIPT_GML = os.path.join(SCRIPTS_ROOT, "las_to_lod2", "05_json_to_gml2.py")
